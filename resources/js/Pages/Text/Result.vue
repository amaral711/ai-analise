            ...
            <div class="max-w-3xl mx-auto space-y-5">
                ...
                <div class="rounded-xl border border-zinc-800 bg-zinc-900 overflow-hidden">
                    <div class="px-6 py-4 border-b border-zinc-800 flex items-center gap-2">
                        ...
                        <h2 class="text-zinc-300 text-sm font-medium">Texto analisado</h2>
                        <span class="ml-auto text-xs text-zinc-600">{{ analysis.content?.length?.toLocaleString('pt-BR') }} caracteres</span>
                    </div>
                    <div class="p-6 bg-zinc-950">
                        <p class="text-zinc-400 text-sm leading-relaxed whitespace-pre-wrap">{{ textPreview }}</p>
                    </div>
                </div>
