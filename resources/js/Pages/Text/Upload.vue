    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <a :href="route('text-analyses.index')" class="text-sm text-zinc-500 dark:text-zinc-500 hover:text-violet-600 dark:hover:text-violet-400 transition-colors flex items-center gap-1.5">
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-5">
                        ...
                        <div class="space-y-2">
                            <textarea
                                ...
                                class="w-full rounded-xl bg-slate-50 dark:bg-zinc-800/60 border border-slate-200 dark:border-zinc-700
                                       text-zinc-800 dark:text-zinc-200 text-sm placeholder-slate-400 dark:placeholder-zinc-500
                                       focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 dark:focus:border-violet-500/60
                                       resize-none p-4 transition-colors"
                                :class="form.errors.content ? 'border-red-400 dark:border-red-500/60' : ''"
                            ></textarea>
                            ...
                            <div class="flex items-center justify-between px-1">
                                ...
                                <span class="text-xs text-zinc-400 dark:text-zinc-600">{{ charLeft.toLocaleString('pt-BR') }} restantes</span>
                            </div>
                        </div>
