    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-foreground text-base font-semibold">Análise de Áudio</h1>
                    <p class="text-muted-foreground text-sm mt-0.5">Detecte se um áudio foi gerado por inteligência artificial</p>
                </div>
                <a :href="route('audio-analyses.index')" class="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-1.5">
                ...
                <div class="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
                    <form @submit.prevent="submit" class="p-6 space-y-5">
                        ...
                        <label
                            ...
                            :class="audioSrc
                                ? 'border border-primary bg-primary/5 p-6'
                        ...
                        >
                            ...
                            <div v-if="audioSrc" class="w-full space-y-3">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-xs text-primary font-medium truncate">{{ selectedFile.name }}</p>
                            ...
                            <div v-else class="flex flex-col items-center gap-3">
                                ...
                                <div class="text-center">
                                    <p class="text-sm text-muted-foreground">Clique para selecionar ou arraste o áudio</p>
                                    <p class="text-xs text-muted-foreground mt-1">MP3, WAV, OGG, M4A — máx. 25 MB</p>
                                </div>
                            </div>
