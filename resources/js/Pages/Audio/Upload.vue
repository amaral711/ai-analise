                ...
                <div class="rounded-xl border border-zinc-800 bg-zinc-900 overflow-hidden">
                    <form @submit.prevent="submit" class="p-6 space-y-5">
                        ...
                        <label
                            ...
                            :class="audioSrc
                                ? 'border border-violet-500 bg-violet-500/5 p-6'
                        ...
                        >
                            ...
                            <div v-if="audioSrc" class="w-full space-y-3">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="w-9 h-9 rounded-lg bg-violet-500/20 flex items-center justify-center flex-shrink-0">
                            ...
                            <div v-else class="flex flex-col items-center gap-3">
                                ...
                                <div class="text-center">
                                    <p class="text-sm text-zinc-400">Clique para selecionar ou arraste o áudio</p>
                                    <p class="text-xs text-zinc-600 mt-1">MP3, WAV, OGG, M4A — máx. 25 MB</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <a :href="route('audio-analyses.index')" class="text-sm text-zinc-500 hover:text-violet-400 transition-colors flex items-center gap-1">
