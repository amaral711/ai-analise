...
<template>
    <GuestLayout>
        ...
        <div class="mb-8">
            ...
            <p class="text-zinc-400 text-sm mt-1">Comece a detectar conteúdo gerado por IA agora mesmo</p>
        </div>

        <form @submit.prevent="submit" class="space-y-4">
            <div>
                <label for="name" class="block text-sm font-medium text-zinc-300 mb-1.5">Nome</label>
                <input
                    id="name"
                    v-model="form.name"
                    type="text"
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-medium text-zinc-300 mb-1.5">Confirmar senha</label>
                <input
        ...
        <p class="mt-6 text-center text-sm text-zinc-500">
            Já tem uma conta?
            <Link :href="route('login')" class="text-violet-400 hover:text-violet-300 font-medium transition-colors">
                Entrar
            </Link>
        </p>
    </GuestLayout>
