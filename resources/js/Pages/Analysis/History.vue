    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-foreground text-base font-semibold">Histórico de Análises</h1>
                ...
                <div v-if="analyses.data.length === 0" class="rounded-xl border border-border bg-card">
                    <div class="py-20 flex flex-col items-center gap-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted-foreground text-sm mt-1">Faça sua primeira análise para ver o histórico aqui.</p>
                        </div>
                        <Link
                            :href="route('dashboard')"
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b border-border">
                                <th class="px-6 py-3.5 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Imagem</th>
